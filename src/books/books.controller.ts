import { Controller, Get, Post, Body, Patch, Param, Delete, ParseUUIDPipe, NotFoundException, Put } from '@nestjs/common';
...
export class BooksController {
  ...
  @Put(':id')
  @ApiAcceptedResponse({ description: "Book updated successfully" })
  @ApiNotFoundResponse({ description: "Book not found" })
